...
function IndexPage() {
  const playText =
    "Growth is not always a smooth journey, but every step is worth documenting. In this blog, I will share my explorations and discoveries in both personal and professional life.😊";
  ...
  return (
    <Layout>
      ...
      <BackgroundCloth>
        <div
          className={`${S.lineClamp} w-2/3 mx-auto text-4xl indent-4 leading-normal text-white font-bold`}
        >
          <span ref={el} />
        </div>
      </BackgroundCloth>
      {/*中间文字*/}
      <div
        className={`mx-auto text-5xl font-bold w-full h-56`}
        ref={domElementRef}
      >
      ...
      <div className={`${S.buttonGrid} text-center mt-6`}>
        ...
        <Button size={"large"} type={"primary"} onClick={seeMore}>
          More
        </Button>
      </div>
      {/*Card*/}
